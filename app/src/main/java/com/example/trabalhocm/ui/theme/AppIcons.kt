...
object AppIcons {
    ...
    // Conteúdo da app
    val Tournaments = Icons.Filled.EmojiEvents
    val Teams = Icons.Filled.Groups
    val Games = Icons.Filled.SportsSoccer
    val Calendar = Icons.Filled.CalendarMonth
    val Ranking = Icons.Filled.Leaderboard
